...
public class PlayerInteractManager {
    ...
    public EnumInteractionResult a(EntityHuman entityhuman, World world, ItemStack itemstack, EnumHand enumhand) {
        ...
        if (entityhuman.df().a(itemstack.getItem())) {
            ...
            if (event.useInteractedBlock() == Event.Result.DENY) {
                ...
                if ((!entityhuman.isSneaking()) || ((entityhuman.getItemInMainHand() == null) && (entityhuman.getItemInOffHand() == null))) {
                    ...
                    if (block instanceof BlockCommand) {
                        ...
                        result = block.interact(world, blockposition, blockdata, entityhuman, enumhand, itemstack, enumdirection, f, f1, f2) ? EnumInteractionResult.SUCCESS
